...
namespace DailyShop.DataAccess.Migrations
{
    ...
    [Migration("20231231171307_add_table_reportuserandreview")]
    partial class add_table_reportuserandreview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyShop.Entities.Concrete.ReportReview", b =>
                {
                    ...
                    b.Property<int?>("ReporterReviewId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DailyShop.Entities.Concrete.ReportReview", b =>
                {
                    b.HasOne("DailyShop.Entities.Concrete.Review", "ReporterReview")
                        .WithMany()
                        .HasForeignKey("ReporterReviewId");

                    b.HasOne("DailyShop.Entities.Concrete.Review", "Review")
                        .WithMany()
                        .HasForeignKey("ReviewId");

                    b.Navigation("ReporterReview");
